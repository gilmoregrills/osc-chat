...
- [ ] add global settings (vol?? bpm??) to option groups in control channel
  - [x] add bpm control
- [x] make it so you can apply multiple effects channels to one instrument/synth channel
- [x] add more voices to the instrument channels
- [x] add some visual feedback on channels when settings are changed
